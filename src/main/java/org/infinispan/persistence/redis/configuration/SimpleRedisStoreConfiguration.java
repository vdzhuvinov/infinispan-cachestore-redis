...
@ConfigurationFor(SimpleRedisStore.class)
public class SimpleRedisStoreConfiguration extends AbstractStoreConfiguration
{
    ...
    public static AttributeSet attributeDefinitionSet() {
        return new AttributeSet(SimpleRedisStoreConfiguration.class, AbstractStoreConfiguration.attributeDefinitionSet(),
    ...
    public SimpleRedisStoreConfiguration(
